...
void McuDrvUsart2Configuartion(uint32_t BaudVal)
{
    USART_InitType  USART_InitTypeStruct;
    
    USART_InitTypeStruct.BaudRate               =   BaudVal;
    USART_InitTypeStruct.HardwareFlowControl    =   USART_HFCTRL_NONE;
    USART_InitTypeStruct.Mode                   =   USART_MODE_RX | USART_MODE_TX;
    USART_InitTypeStruct.Parity                 =   USART_PE_NO;
    USART_InitTypeStruct.StopBits               =   USART_STPB_1;
    USART_InitTypeStruct.WordLength             =   USART_WL_8B;
