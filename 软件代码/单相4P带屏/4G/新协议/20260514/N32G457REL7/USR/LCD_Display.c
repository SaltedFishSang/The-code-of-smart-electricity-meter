...
void Display_pageinit(void)
{
    ...
    /*显示是否定时*/
    DisplayClockState(Switch_Status.SwitchTimevalue);
    /*显示图标*/
    ...
    TFTLCD_ShowString(172, 96, "mA", BLACK, LGRAY, 24, 0);
    /*显示功率*/
    ...
    DisplayOutputState(Switch_Status.SwitchOnvalue);
    /*显示锁扣*/
    DisplayLockState(Switch_Status.SwitchLockvalue);
}
/*!
...
void DisplayClockState(u8 state)
{
    ...
    case 0:
        ...
        TFTLCD_ShowString(232, 12, "    ", BLACK, LGRAY, 24, 0);
        break;
    case 1:
        TFTLCD_ShowCN(232, 12, 0, MAGENTA, LGRAY, 16, 0);
        TFTLCD_ShowCN(248, 12, 1, MAGENTA, LGRAY, 16, 0);
        TFTLCD_ShowCN(264, 12, 2, MAGENTA, LGRAY, 16, 0);
        break;
    default:
        break;
    }
