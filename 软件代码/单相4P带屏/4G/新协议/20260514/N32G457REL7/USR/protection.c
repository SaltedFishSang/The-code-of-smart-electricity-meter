...
//        if (data1 & (1 << 1))
//        {
//					if(LosePwrCheck()==0)//有电的情况下 才去跳闸 停电的情况下不跳闸
//					{
//						Relay_Control(0);
//            Modbus_WirteDI(1, 0);
...
//        {
//            // 判断现在的时间点
//            if ((RtcTime.hours == (Modbus_Readremain(15 + 2 * i) >> 8)) && (RtcTime.minutes == (Modbus_Readremain(15 + 2 * i) & 0xff))) // 在时间点上
//            {
//                   if ((Modbus_Readremain(15 + 2 * i - 1) & 0xff) & (1 << (RtcTime.weekday - 1))) // 判断今天周几  这个点今天有没有选上
//                {
//                    // 选上了 判断这个点是开还是关
