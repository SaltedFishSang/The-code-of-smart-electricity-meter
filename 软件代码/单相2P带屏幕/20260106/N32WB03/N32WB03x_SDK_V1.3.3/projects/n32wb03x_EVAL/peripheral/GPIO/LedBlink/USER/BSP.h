...
#define LedAlarmOn GPIO_ResetBits(GPIOB, GPIO_PIN_0)
#define LedAlarmOff GPIO_SetBits(GPIOB, GPIO_PIN_0)
...
extern void ModeInput_gpioInit(void);
extern void Delay_MS(u16 Count);
extern void Delay_100uS(u16 Count);
#endif
