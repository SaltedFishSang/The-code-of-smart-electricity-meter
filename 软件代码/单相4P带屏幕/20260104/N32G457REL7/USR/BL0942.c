...
#endif
    // BL0942_EleData.vol = 222;
    // BL0942_EleData.current = 20100; // mA
    // BL0942_EleData.power = 2345;
    // BL0942_EleData.energy = 1000123; // 保留小数点后三位
...
//    BL0942_EleData.vol = 0;
//    BL0942_EleData.current = 0; // mA
//    BL0942_EleData.power = 0;
//    BL0942_EleData.energy = 0; // 保留小数点后三位
}
/*!
