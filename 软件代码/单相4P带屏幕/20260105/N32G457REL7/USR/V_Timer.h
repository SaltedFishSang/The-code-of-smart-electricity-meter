...
typedef enum {VTIM0,VTIM1,VTIM2,VTIM3,VTIM4,VTIM5,VTIM6,VTIM7,VTIM8,VTIM9,VTIM10,VTIM11,VTIM12,VTIM13,VTIM14,VTIM15,VTIM16,VTIMER_NUM} VtimerName_t;//VtimerName_t 是enum VtimerName的别名
